...
----
4.18.26 4.18.25 4.18.24 4.18.23 4.18.22 4.17.41 4.17.40 4.17.39 4.17.38 4.17.37 4.17.36 4.17.35 4.17.28
----
To get the most recent upgrade we can run the following command:
+
[source,sh,role=execute]
----
oc get clusterversion version -o \
  jsonpath='{.status.availableUpdates[0].version}'; echo
----
+
.Sample Output
[source,text,options=nowrap]
...
managed-upgrade-config   4.18.26           Pending
----
